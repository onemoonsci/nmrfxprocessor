...
public class RelaxEquations {
    ...
    private static final double r = 1.02e-10;
    ...
    public static double J(double w, double tau) {
        double value = 0.4 * tau / (1.0 + w * w * tau * tau);
        return value;
    }

    public static double J0(double tau) {
        double value = 0.4 * tau;
        return value;
    }

    public static double T1(double tau) {
    ...
    public static double T2(double tau) {
        double wH = 800.0e6 * 2.0 * Math.PI;
        double wN = Math.abs(wH * GAMMA_N / GAMMA_H);
    ...
    public static double T2s(double tau) {
    ...
    public static double TRACTdeltaAlphaBeta(double B0, double tauC) {
        double ddN = 160.0e-6;
