...
public class HausdroffDistance {
    ...
    public HausdroffDistance(Set<Collection> setA, Set<Collection> setB) {
        this.setA = setA;
        this.setB = setB;
    }

    public static Double distance(Collection ptA, Collection ptB) throws IllegalArgumentException {
    ...
    public Double calculate() throws IllegalArgumentException {
        // brute force algorithm to calculate Hausdroff distance b/t sets A,B
